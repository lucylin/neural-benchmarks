...
matrix multiplication. In every framework, one of the most used function calls is
a variant of \texttt{magma\_lds128\_sgemm\_kernel}, used for matrix multiplication.

\begin{center}
\textbf{Time spent in various functions}
\end{center}
...
%% BOX 2
\headerbox{Conclusions and Recommendations}{name=results,column=2,row=0.68, span=1}{

\begin{wrapfigure}{r}{0.4\textwidth}
\includegraphics[scale=.4]{../paper/graphics/tensorflowGraph.png}
\end{wrapfigure}

Many tradeoffs to consider when selecting a framework: none of the tested frameworks
win or lose across the board.

\begin{itemize}\addtolength{\itemsep}{-0.5\baselineskip}
    \item Performance: see above!
    \item Simple or complicated installation?
    \item Is it well-documented?
    \item Is there a steep learning curve?
    \item Are there convenient built-ins?
    \item How difficult is it to debug computation graphs?
\end{itemize}
