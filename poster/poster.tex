...
\item nlp is natural
\item the natural is about the processing, not the language
\end{itemize}\vspace*{5pt}

\begin{tabular}{cc}
\includegraphics[width=.24\columnwidth]{graphics/python.png}
\hspace*{20pt} & \hspace*{-15pt}\parbox{0.62\textwidth}{
\vspace*{-40pt}\textbf{Deep learning}
...
\includegraphics[width=.24\columnwidth]{graphics/LAtimes.jpeg}
...
\textbf{Data}
\begin{itemize}\addtolength{\itemsep}{-0.5\baselineskip}
\item Split into sentences then words using NLTK
...
%% Box 2
\headerbox{Hyper params?}{name=intro1,column=0,row=0.75, span=1}{
\color{black}
??
\vspace{.4pt}
}
...
%% BOX 0
\headerbox{Logos \& Graphs}{name=results,column=1,row=0.00, span=2}{
...
%% Box 3
\headerbox{What else?}{name=methods,column=1,row=0.69, span=1}{
\color{black}
}
...
%% BOX 0
%\headerbox{Search Results}{name=results,column=2,row=0, span=1}{
%\begin{center}
%\includegraphics[scale=.5]{graphics/searchResults.JPG}
%
%\end{center}
%\begin{itemize}\addtolength{\itemsep}{-0.5\baselineskip}%\addtolength{\itemindent}{-5pt}
%\item Search for words or phrases in the document text
%\item Filter on frames to examine relationships between the language used and the frame evoked
%\item Search via the wordcloud, the search bar, or by clicking on frames in search results
%\end{itemize}
%}
...
%% BOX 2
\headerbox{How many GPUs should I buy?}{name=results,column=2,row=0.69, span=1}{
}
